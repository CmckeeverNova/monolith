...
def test_create_notebook(mock_notebook_service, override_dependency):
    ...
    mock_notebook_service.create_notebook.return_value = NotebookResponse(id="1", name="New Notebook")
...
def test_get_notebook_by_id_success(mock_notebook_service, override_dependency):
    ...
    mock_notebook_service.get_notebook_by_id.return_value = NotebookResponse(id="1", name="Notebook 1")
